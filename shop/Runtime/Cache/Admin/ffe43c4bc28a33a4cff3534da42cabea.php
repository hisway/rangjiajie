      ...
      [
          ...
          [
            {text:'商品管理',items:
              [
                ...
                {id:'2',text:'添加商品',href:'Admin/Node/index.html'},
            ...
            {text:'商品属性管理',items:
              [
                {id:'1',text:'品牌管理',href:'Admin/Node/index.html'},
                {id:'2',text:'商品分类',href:'Admin/Node/index.html'},
                {id:'3',text:'商品评论',href:'Admin/Node/index.html'},
                {id:'4',text:'商品关键字',href:'Admin/Node/index.html'}
              ]
            }
          ]
        },
        ...
        {id:'3',homePage : '1',menu:
          [
            {text:'会员管理',items:
              [
                {id:'1',text:'会员列表',href:'Admin/Node/index.html'},
                {id:'2',text:'添加会员',href:'Admin/Node/index.html'}
              ]
            },
            {text:'会员等级管理',items:
              [
